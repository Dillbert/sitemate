...
- use the Service unlawfully, fraudulently, or in any way that infringes others’ rights;
- upload malware, attempt unauthorised access to our systems or other users’ data, or disrupt the Service;
- use the Service to store or distribute illegal content or content you have no right to use;
- scrape, reverse engineer, or circumvent technical limits except as allowed by law;
...
- we are not liable for any **indirect, consequential, special, or punitive** damages, or for **loss of profit, data, goodwill, or business**; and  
- our total aggregate liability for any claim arising out of or relating to the Service or these Terms is limited to the greater of **£100** or the amount you paid us **directly** for the Service in the **12 months** before the claim (excluding amounts paid through Apple/Google for subscriptions, which are between you and the store).
...
- these Terms are between you and **Dylan Stables**, not Apple Inc.;
- Apple has no obligation to furnish any maintenance or support for the App beyond what is required by law;
